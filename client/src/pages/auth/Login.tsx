      ...
      <Card>
        ...
        <CardContent className="flex flex-col gap-4">
          ...
          <div className="relative z-10 text-center">
            ...
            <p className="inline-block px-4 text-sm uppercase bg-white text-muted-foreground">
              Or Login With Email
            </p>
          </div> */}
          <InputField
          ...
          <div className="flex items-center justify-between px-0.5">
            ...
            <Link
              to="/recover-password"
              className="text-sm underline cursor-pointer underline-offset-2 hover:text-primary hover:decoration-primary"
            >
              Forgot password?
            </Link>
          </div>
